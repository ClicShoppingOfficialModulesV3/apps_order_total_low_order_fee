 ...
 */
  ...
  class Install extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    public function execute() {
      ...
      $CLICSHOPPING_LowOrderFee->loadDefinitions('Sites/ClicShoppingAdmin/install');
    ...
    private static function installDbMenuAdministration() {
      ...
      $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_order_total_low order fee']);

      if ($Qcheck->fetch() === false) {

        $sql_data_array = ['sort_order' => 4,
                           'link' => 'index.php?A&OrderTotal\LowOrderFee&Configure',
                           'image' => 'modules_order_total.gif',
                           'b2b_menu' => 0,
                           'access' => 1,
                           'app_code' => 'app_order_total_low order fee'
                          ];
        ...
        for ($i=0, $n=count($languages); $i<$n; $i++) {
          ...
          $sql_data_array = ['label' => $CLICSHOPPING_LowOrderFee->getDef('title_menu')];
